...
- Module 3/7 (Basic): Command tạo note nhanh từ text được chọn (hotkey, §3.7) — dùng lại
  Deck/Model đã lưu (§7.4) + content skeleton (§3.6), không cần AI Provider nên không phụ
  thuộc Milestone 3
- **Deliverable:** Plugin có Sidebar Modal, tự động sinh content structure dựa trên Model, và có thể tạo note nhanh bằng hotkey từ text đang bôi đen
