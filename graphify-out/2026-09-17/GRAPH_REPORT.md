...
## Corpus Check
- 86 files · ~51,411 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 571 nodes · 822 edges · 81 communities (24 shown, 57 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1dee2209`
...
Cohesion: 0.10
Nodes (25): ALWAYS_VISIBLE_BUTTONS, ControlAction, ControlButtonSpec, DELETE_BUTTON, handleDeleteClick(), handleSync(), performDelete(), renderControlsBlock() (+17 more)
...
Cohesion: 0.08
Nodes (40): plugin, $schema, .opencode/plugins/graphify.js, AnkiBridgePlugin, generateContentSkeleton(), registerControlsBlock(), runCreateNote(), fakePlugin() (+32 more)

### Community 77 - "sidebarView.test.ts"
Cohesion: 0.09
Nodes (10): { deckNamesMock, modelNamesMock, AnkiConnectClient }, fakeApp(), FakeButtonComponent, FakeDropdownComponent, FakeFolder, fakePlugin(), FakeSetting, fakeSettings() (+2 more)
