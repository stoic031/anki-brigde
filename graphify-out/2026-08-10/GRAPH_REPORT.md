...
## Corpus Check
- 57 files · ~37,160 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 339 nodes · 333 edges · 78 communities (20 shown, 58 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c2a9992d`
...
4. `AnkiConnectClient` - 9 edges
5. `Graphify Full Pipeline` - 9 edges
...
## Communities (78 total, 58 thin omitted)
...
Cohesion: 0.21
Nodes (3): AnkiConnectClient, AnkiConnectResponse, AnkiConnectError
