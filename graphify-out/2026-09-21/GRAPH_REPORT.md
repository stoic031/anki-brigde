...
## Corpus Check
- 102 files · ~61,481 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 718 nodes · 1086 edges · 90 communities (32 shown, 58 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8f987fb7`
...
### Community 14 - "Common Provider Interface (processText/generateAudio/generateImage)"
Cohesion: 0.12
...
Cohesion: 0.05
Nodes (51): plugin, $schema, .opencode/plugins/graphify.js, AnkiBridgePlugin, { loadSettings, saveSettings }, { PluginBase, addCommandSpy }, { registerSidebarView, revealSidebarView }, { runCreateNote } (+43 more)
...
### Community 84 - "Generate with AI Button"
Cohesion: 0.23
...
### Community 85 - "providers/types.ts"
Cohesion: 0.17
Nodes (8): AudioOptions, AudioProvider, ImageOptions, ImageProvider, MediaResult, TextProvider, TextResult, TextTask
...
### Community 87 - "Scenario 1: Create Note via Icon/Command"
Cohesion: 0.32
...
### Community 88 - "Sidebar Modal (Right Sidebar View Panel)"
Cohesion: 0.29
...
- **Why does `AnkiBridgePlugin` connect `sidebarView.ts` to `sidebarView.test.ts`, `settingsTab.test.ts`, `quickCapture.ts`, `FakeEl`, `createNote.test.ts`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `FakeEl` connect `FakeEl` to `sidebarView.ts`, `sidebarView.test.ts`?**
