...
## Corpus Check
- 92 files · ~57,682 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 621 nodes · 917 edges · 81 communities (24 shown, 57 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f5bf0e15`
...
Cohesion: 0.09
Nodes (30): ALWAYS_VISIBLE_BUTTONS, ControlAction, ControlButtonSpec, DELETE_BUTTON, handleDeleteClick(), handleSync(), performDelete(), registerControlsBlock() (+22 more)

## Knowledge Gaps
- **195 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `id`, `name`, `version` (+190 more)
...
- **Why does `AnkiBridgePlugin` connect `quickCapture.ts` to `settingsTab.test.ts`, `sidebarView.test.ts`, `controlsBlock.ts`, `SidebarView`?**
