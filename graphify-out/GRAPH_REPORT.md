...
## Corpus Check
- 86 files · ~49,468 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 541 nodes · 756 edges · 81 communities (25 shown, 56 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `eaf218ee`
...
2. `AnkiConnectClient` - 17 edges
3. `graphify Skill (/graphify)` - 17 edges
4. `runQuickCapture()` - 16 edges
5. `compilerOptions` - 16 edges
6. `AnkiBridgePlugin` - 13 edges
7. `runCreateNote()` - 13 edges
8. `syncNote()` - 13 edges
9. `toastError()` - 11 edges
10. `writeAnkiFrontmatter()` - 10 edges
...
Cohesion: 0.06
Nodes (30): AnkiConnectClient, { requestUrl }, mapContentToFields(), stringifySectionValue(), extractSectionValue(), parseSections(), readAnkiFrontmatter(), file (+22 more)
...
Cohesion: 0.08
Nodes (36): plugin, $schema, .opencode/plugins/graphify.js, AnkiBridgePlugin, generateContentSkeleton(), runCreateNote(), sanitizeForFilename(), AppWithSettingTab (+28 more)
...
Cohesion: 0.33
Nodes (5): { loadSettings, saveSettings }, { PluginBase, addCommandSpy }, { registerControlsBlock }, { registerSidebarView }, { runQuickCapture }
...
## Knowledge Gaps
- **184 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `id`, `name`, `version` (+179 more)
