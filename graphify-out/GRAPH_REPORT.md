...
## Corpus Check
- 79 files · ~45,442 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 475 nodes · 602 edges · 80 communities (22 shown, 58 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6e2f1e67`
...
Cohesion: 0.05
Nodes (38): generateContentSkeleton(), ALWAYS_VISIBLE_BUTTONS, ControlAction, ControlButtonSpec, DELETE_BUTTON, AnkiConnectClient, AnkiConnectResponse, { requestUrl } (+30 more)
...
Cohesion: 0.12
Nodes (19): plugin, $schema, .opencode/plugins/graphify.js, AnkiBridgePlugin, handleSync(), performDelete(), registerControlsBlock(), AnkiBridgeSettings (+11 more)
...
## Knowledge Gaps
- **164 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `id`, `name`, `version` (+159 more)
...
- **Why does `AnkiConnectClient` connect `controlsBlock.ts` to `controlsBlock.test.ts`, `settingsTab.ts`?**
