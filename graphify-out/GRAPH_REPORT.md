...
## Corpus Check
- 88 files · ~54,469 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 593 nodes · 873 edges · 82 communities (25 shown, 57 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ca2f609a`
...
Cohesion: 0.07
Nodes (41): plugin, $schema, .opencode/plugins/graphify.js, AnkiBridgePlugin, AiButtonAction, AiPreCheckResult, runAiPreCheck(), generateContentSkeleton() (+33 more)

### Community 79 - "[1.0.0]"
Cohesion: 0.40
Nodes (4): [1.0.0], Added, Changelog, Fixed

### Community 80 - "controlsBlock.ts"
Cohesion: 0.06
Nodes (35): ALWAYS_VISIBLE_BUTTONS, ControlAction, ControlButtonSpec, DELETE_BUTTON, handleDeleteClick(), handleSync(), performDelete(), registerControlsBlock() (+27 more)
...
- **Why does `AnkiConnectClient` connect `controlsBlock.ts` to `quickCapture.ts`, `controlsBlock.test.ts`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `NoteNameModal` connect `noteNameModal.test.ts` to `quickCapture.ts`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `AnkiBridgePlugin` connect `quickCapture.ts` to `SidebarView`, `sidebarView.test.ts`, `settingsTab.test.ts`, `controlsBlock.ts`, `main.test.ts`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
